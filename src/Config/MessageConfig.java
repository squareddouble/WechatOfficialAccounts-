...
//	appID和appsecret每个开发账号均不同，请修改为自己账号所对应的变量
	...
	//项目名称
	String PROJECT_NAME = "wechatAutoResponder";
	//服务器前缀，请改为自己的测试服务器
	String servletURL = "http://lonmao.iok.la/" + PROJECT_NAME;
	...
	String UNLOGINMESSAGE = "你尚未绑定账号，请先绑定账号！<a href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + appID + "&redirect_uri=" + servletURL + "/PIM/Register/login.jsp&response_type=code&scope=snsapi_base&state=123#wechat_redirect'>账号绑定</a>";
}
